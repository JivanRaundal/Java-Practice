...
interface Intr1
{
	...
	void disp();					//abstract & public by default (rule-2)
}

interface Intr2 extends Intr1		//rule-9
{
	void show();					//abstract & public by default (rule-2)
}

class Myclass implements Intr2		//rule-3 (to fill up the requirements of Multiple Inheritance )
{ 
	public void show()
	{
		System.out.println("\nIn show() x = " + x);			
