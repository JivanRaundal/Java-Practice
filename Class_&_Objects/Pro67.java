...
class Outer			//Outer class
{
	class Inner		//Inner class
	{
		...
		public void show()
		{
			System.out.println("In Inner show(), x = " + x);
		}
	}
...
class Pro67
{
	public static void main(String args[])
	{
		...
		//creating object of class Inner in non-member function
		//Note :- to create object of class Inner, we should have object of class Outer also
		
		Outer.Inner ref;			//created reference variable of class Inner
		//ref = new Outer.Inner();	//error
		ref = out.new Inner();		//created object of class Inner, using object of class Outer
