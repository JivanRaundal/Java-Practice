...
class Number
{
	...
	public Number(Number Temp)		//In 1 parameterized constructor (object of same class is parameter)
	{
		x = Temp.x;
		y = Temp.y;
	...
	public Number(int x,int y)		//2 parameterized constructor
	{
		this.x = x;
		this.y = y;
		System.out.println("In 2 parameterized constructor");
	}
...
class Pro52_const
{
	public static void main(String args[])
	{
		...
		Number obj,var;
		obj = new Number(10,20);		// 2 parameterized constructor 
		var = new Number(obj);			//1 parameterized constructor (passing object of same class as a parameter)
