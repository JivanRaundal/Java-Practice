...
class Pro53_finalize
{
	public static void main(String args[])
	{
		...
		while(true)
		{
			//waiting here for Garbage Collector to come & execute finalize()
			//here, we dont know when finalize() will execute bcz we dont know when GC will execute
		}
		
		//var.finalize();				//we can call finalize() using object & dot(.)
