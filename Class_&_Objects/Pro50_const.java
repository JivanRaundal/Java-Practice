...
class Number
{
	...
	public Number(int a)			//1 parameterized constructor
	{
		x = a;
...
class Pro50_const
{
	public static void main(String args[])
	{
		System.out.println("\nMain() starts");
		Number obj,var,ref;
		obj = new Number();				//default constructor will get called
		var = new Number(10);			//1 parameterized constructor gets called
		ref = new Number(5,6);			//2 parameterized constructor gets called
