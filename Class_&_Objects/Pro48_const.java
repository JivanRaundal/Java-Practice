...
class Number
{
	...
	public void Number()				//Rule 3 (no returntype for constructor, but if mention then it's just normal member function)
	{
		System.out.println("\nNot a default constructor, it's normal member function");
		x = 10;
		y = 20;
	}
...
class Pro48_const
{
	...
	{
		Number obj;
		obj = new Number();				//default constructor will get called provide by JVM
		
		obj.Number();			//calling non-static member function Number()
		obj.show();
	}
}